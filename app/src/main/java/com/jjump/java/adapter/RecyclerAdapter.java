...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ItemViewHolder> {
    ...
    private ArrayList<WordlistDates> listData = new ArrayList<>();
    ...
    public void addItem(WordlistDates data) {
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(WordlistDates data) {
            tv_dates.setText(data.getDates());
        }
    }
}